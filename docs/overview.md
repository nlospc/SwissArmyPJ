...
- 📊 **Dashboard** - 项目组合总览、风险分析、变更动态

- 📋 **My Work** - 个人任务管理、时间跟踪、番茄钟

- 📁 **Projects** - 项目管理、层级任务、Excel 风格甘特图

- 📥 **Inbox** - 快速捕获、智能分类、批量处理

- 📈 **Timeline** - 可视化时间线、依赖关系、关键路径

- 🔍 **Search** - FTS5 全文搜索、跨项目查询

- ⚙️ **Settings** - 用户偏好、数据导入/导出、主题设置
