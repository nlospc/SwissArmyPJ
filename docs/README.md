...
欢迎来到 SwissArmyPM 项目文档。这里包含了项目的完整技术文档、开发指南和架构说明。
...
- [项目概述](./overview.md) - 项目介绍和核心概念

- [当前状态](./current-status.md) - 🆕 项目实施进度和状态汇总

- [快速开始](./getting-started.md) - 安装和运行指南

- [技术栈](./tech-stack.md) - 技术选型和架构说明



### 开发指南

- [组件库指南](./component-library.md) - Ant Design v5 集成指南

- [迁移指南](./migration-guide.md) - 从 Radix UI 迁移到 Ant Design v5

- [甘特图架构](./gantt-architecture-summary.md) - Timeline/Gantt 组件设计

- [甘特图集成](./gantt-library-integration.md) - vis-timeline 库集成



### 架构文档

- [架构设计](./architecture/ARCHITECTURE.md) - 高层架构设计

- [数据模型](./architecture/data-model.md) - 实体关系模型

- [IPC 处理器参考](./architecture/ipc-handlers-reference.md) - IPC 命令完整参考

- [My Work 蓝图](./architecture/my-work-blueprint.md) - My Work 功能详细设计
...
- 🚀 **轻量级** - 基于 Electron 的桌面应用，资源占用低
- 🎨 **现代化 UI** - 使用 Ant Design v5 组件库
- 🧠 **AI 集成** - 内置 AI 辅助功能
