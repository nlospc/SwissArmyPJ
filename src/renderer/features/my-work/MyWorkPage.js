...
export function MyWorkPage() {
    ...
    useMyWorkInit();
    return (_jsxs("div", { className: "flex flex-col h-full bg-theme-container", children: [_jsx("div", { className: "bg-theme-container border-b px-6 py-4", children: _jsx("h1", { className: "text-2xl font-bold text-gray-900", children: "My Work" }) }), _jsxs("div", { className: "flex-1 overflow-hidden flex", children: [_jsx("div", { className: "flex-1 overflow-auto border-r bg-theme-container", children: _jsx(TodoListContainer, {}) }), _jsx("div", { className: "w-80 overflow-auto bg-theme-container", children: _jsx(TrackerSidebar, {}) })] }), _jsx("div", { className: "bg-theme-container border-t", children: _jsx(StatsBar, {}) })] }));
}
