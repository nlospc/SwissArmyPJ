...
function ResizableSplitPane({ left, right, defaultLeftWidth = 40, minLeftWidth = 20, maxLeftWidth = 60, }) {
    ...
    return (_jsxs("div", { ref: containerRef, className: "flex h-full w-full overflow-hidden", children: [_jsx("div", { ref: leftPaneRef, style: { width: leftWidth + '%' }, className: "flex-shrink-0 overflow-y-auto overflow-x-hidden border-r border-theme-border", onScroll: handleLeftScroll, children: left }), _jsx("div", { className: `
