    ...
    const columns = [
        {
            ...
            render: (text, record) => (_jsx("div", { className: `cursor-pointer p-2 rounded transition-colors ${selectedItem?.id === record.id
                    ...
                    : 'hover:bg-theme-container dark:hover:bg-gray-800'}`, onClick: () => handleSelectItem(record), children: _jsx("div", { className: "line-clamp-2", children: text }) })),
        },
        {
            title: 'Date',
