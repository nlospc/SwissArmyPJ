 ...
 */
export function dateToPixel(date, viewStart, columnWidth, scale) {
 ...
 */
export function pixelToDate(pixel, viewStart, columnWidth, scale) {
    const dayWidth = getDayWidth(scale, columnWidth);
 ...
 */
export function getDayWidth(scale, columnWidth) {
    switch (scale) {
        case 'day':
 ...
 */
export function getTimelineWidth(viewStart, viewEnd, columnWidth, scale) {
    const dayWidth = getDayWidth(scale, columnWidth);
 ...
 */
export function formatDateLabel(date, scale) {
    switch (scale) {
        case 'day':
...
export function generateHeaderColumns(viewStart, viewEnd, scale) {
    const columns = [];
...
export function generateGridLines(viewStart, viewEnd, scale, columnWidth) {
    const lines = [];
    let current = viewStart.clone();
    while (current.isBefore(viewEnd)) {
...
export function calculateBarPosition(startDate, endDate, viewStart, columnWidth, scale, minBarWidth = 4) {
    if (!startDate) {
        return null;
    }
 ...
 */
export function snapToGrid(date, scale) {
    switch (scale) {
        case 'day':
