...
export function ProjectTable({ projects, onProjectClick }) {
    ...
    return (_jsxs("div", { className: "space-y-4", children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsxs("div", { className: "relative flex-1 max-w-sm", children: [_jsx(Search, { className: "absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-theme-secondary", style: { zIndex: 1 } }), _jsx(Input, { placeholder: "Search projects...", value: filters.search, onChange: (e) => setFilters({ ...filters, search: e.target.value }), style: { paddingLeft: 36 } })] }), _jsxs(Button, { size: "small", onClick: () => setShowFilters(!showFilters), children: [_jsx(Filter, { className: "h-4 w-4", style: { marginRight: 8 } }), "Filters", activeFilterCount > 0 && (_jsx("span", { className: "ml-1 rounded-full bg-blue-600 px-2 py-0.5 text-xs text-white", children: activeFilterCount }))] }), activeFilterCount > 0 && (_jsx(Button, { type: "text", size: "small", onClick: clearFilters, children: "Clear all" }))] }), showFilters && (_jsxs("div", { className: "border rounded-lg p-4 space-y-4 bg-theme-container", children: [_jsxs("div", { children: [_jsx("label", { className: "text-sm font-medium mb-2 block", children: "Status" }), _jsx("div", { className: "flex flex-wrap gap-2", children: STATUS_OPTIONS.map((option) => (_jsxs("button", { onClick: () => toggleStatusFilter(option.value), className: `px-3 py-1.5 rounded-md text-sm font-medium border transition-colors ${filters.statuses.includes(option.value)
                                        ...
                                        })), className: "flex-1" })] })] })] })), _jsxs("div", { className: "border rounded-lg overflow-hidden", children: [_jsx("div", { className: "overflow-x-auto", children: _jsxs("table", { className: "w-full", children: [_jsx("thead", { className: "bg-theme-container border-b", children: _jsxs("tr", { children: [_jsx(SortableHeader, { field: "status", label: "Status", sortField: sortField, sortOrder: sortOrder, onSort: handleSort }), _jsx(SortableHeader, { field: "name", label: "Project", sortField: sortField, sortOrder: sortOrder, onSort: handleSort }), _jsx(SortableHeader, { field: "owner", label: "Owner", sortField: sortField, sortOrder: sortOrder, onSort: handleSort }), _jsx(SortableHeader, { field: "progress", label: "Progress", sortField: sortField, sortOrder: sortOrder, onSort: handleSort }), _jsx("th", { className: "h-12 px-4 text-left text-sm font-medium text-theme-secondary", children: "Tasks" }), _jsx(SortableHeader, { field: "nextMilestone", label: "Next Milestone", sortField: sortField, sortOrder: sortOrder, onSort: handleSort }), _jsx("th", { className: "h-12 px-4 text-center text-sm font-medium text-theme-secondary", children: "Blockers" }), _jsx("th", { className: "h-12 px-4 text-center text-sm font-medium text-theme-secondary", children: "Risks" }), _jsx("th", { className: "h-12 px-4 text-center text-sm font-medium text-theme-secondary w-20", children: "Actions" })] }) }), _jsx("tbody", { className: "divide-y", children: sortedProjects.length === 0 ? (_jsx("tr", { children: _jsx("td", { colSpan: 9, className: "h-32 text-center text-theme-secondary", children: "No projects found matching your filters" }) })) : (sortedProjects.map((project) => (_jsxs("tr", { className: "hover:bg-theme-container transition-colors cursor-pointer", onClick: () => onProjectClick?.(project), children: [_jsx("td", { className: "px-4 py-3", children: _jsx("span", { className: "text-xl", children: STATUS_ICONS[project.status] }) }), _jsx("td", { className: "px-4 py-3", children: _jsx("div", { className: "font-medium", children: project.name }) }), _jsx("td", { className: "px-4 py-3 text-sm text-theme-secondary", children: project.owner || '—' }), _jsx("td", { className: "px-4 py-3", children: _jsxs("div", { className: "space-y-1", children: [_jsx("div", { className: "h-2 w-full bg-theme-layout rounded-full overflow-hidden", children: _jsx("div", { className: "h-full bg-blue-600 rounded-full transition-all", style: { width: `${project.progressPercent}%` } }) }), _jsxs("div", { className: "text-xs text-theme-secondary", children: [project.progressPercent, "%"] })] }) }), _jsxs("td", { className: "px-4 py-3 text-sm", children: [project.doneTasks, "/", project.totalTasks] }), _jsx("td", { className: "px-4 py-3", children: project.nextMilestone ? (_jsxs("div", { className: "space-y-0.5", children: [_jsx("div", { className: "text-sm font-medium", children: project.nextMilestone.name }), _jsxs("div", { className: "flex items-center gap-1 text-xs text-theme-secondary", children: [formatDate(project.nextMilestone.date), _jsx(MilestoneStatusBadge, { status: project.nextMilestone.status })] })] })) : (_jsx("span", { className: "text-sm text-theme-secondary", children: "\u2014" })) }), _jsx("td", { className: "px-4 py-3 text-center", children: project.blockerCount > 0 ? (_jsx("span", { className: "inline-flex items-center justify-center w-6 h-6 rounded-full bg-red-100 text-red-700 text-xs font-medium", children: project.blockerCount })) : (_jsx("span", { className: "text-theme-secondary", children: "\u2014" })) }), _jsx("td", { className: "px-4 py-3 text-center", children: project.highRiskCount > 0 ? (_jsx("span", { className: "inline-flex items-center justify-center w-6 h-6 rounded-full bg-orange-100 text-orange-700 text-xs font-medium", children: project.highRiskCount })) : (_jsx("span", { className: "text-theme-secondary", children: "\u2014" })) }), _jsx("td", { className: "px-4 py-3", children: _jsx(Button, { type: "text", size: "small", style: { height: 32, width: 32, padding: 0 }, onClick: (e) => {
                                                        e.stopPropagation();
                                                    }, children: _jsx(MoreVertical, { className: "h-4 w-4" }) }) })] }, project.id)))) })] }) }), _jsxs("div", { className: "border-t bg-theme-container px-4 py-2 text-sm text-theme-secondary", children: ["Showing ", sortedProjects.length, " of ", projects.length, " projects"] })] })] }));
}
function SortableHeader({ field, label, sortField, sortOrder, onSort }) {
    const isActive = sortField === field;
    return (_jsx("th", { className: "h-12 px-4 text-left text-sm font-medium text-theme-secondary cursor-pointer hover:text-gray-800 transition-colors select-none", onClick: () => onSort(field), children: _jsxs("div", { className: "flex items-center gap-1", children: [label, _jsx(ArrowUpDown, { className: `h-3 w-3 transition-opacity ${isActive ? 'opacity-100' : 'opacity-30'} ${sortOrder === 'desc' && isActive ? 'rotate-180' : ''}` })] }) }));
}
